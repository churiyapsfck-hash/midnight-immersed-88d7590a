    ...
    <header className="fixed left-0 right-0 top-0 z-40 flex items-center justify-between px-6 py-5 md:px-12">
      <a href="#top" className="flex items-center gap-3">
        <span className="relative inline-flex h-3 w-3 items-center justify-center">
          <span className="absolute h-3 w-3 rotate-45 border border-white/60" />
          <span className="absolute h-1 w-1 rotate-45 bg-[oklch(0.55_0.24_25)] shadow-[0_0_10px_oklch(0.55_0.24_25)] animate-breathe" />
        </span>
        <span className="font-mono text-xs tracking-[0.32em] text-white/80">ILLUMINATI 3.0</span>
      </a>
      <nav className="hidden gap-8 font-mono text-[11px] tracking-[0.28em] text-white/60 md:flex">
        <a href="#tickets" className="transition-colors hover:text-white">01 — ACCESS</a>
        <a href="#gallery" className="transition-colors hover:text-white">02 — DOSSIER</a>
