...
export function ProfileSetupForm({
  ...
  return (
    <motion.form
      ...
      style={{ boxShadow: "0 30px 80px -30px rgba(0,0,0,0.9), inset 0 1px 0 rgba(255,255,255,0.05)" }}
    >
      <div className="font-mono text-[10px] tracking-[0.4em] text-white/50">— DETAILS</div>
      <h2 className="mt-3 font-[Anton] text-4xl leading-[0.9] tracking-tight text-white">
        Complete your <span className="text-white/50">profile.</span>
      </h2>
